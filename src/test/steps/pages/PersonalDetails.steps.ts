...
Then(
  "the personal details page has the heading {string}",
  async ({ ctx }, title: string) => {
    const personalDetailsPage = new PersonalDetailsPage(ctx.base.page);
...
Then(
  "the Contact details section contains below data",
...
Then(
  "Personal details section contains below data",
  async ({ ctx }, data: DataTable) => {
    const personalDetailsPage = new PersonalDetailsPage(ctx.base.page);
    await personalDetailsPage.assertSections(data);
  },
...
Then(
  "Identity numbers section contains below data",
  async ({ ctx }, data: DataTable) => {
    const personalDetailsPage = new PersonalDetailsPage(ctx.base.page);
    await personalDetailsPage.assertSections(data);
  },
...
Then(
  "Staff contacts section contains below data",
  async ({ ctx }, data: DataTable) => {
    const personalDetailsPage = new PersonalDetailsPage(ctx.base.page);
    await personalDetailsPage.assertSections(data);
  },
...
Then(
  "Equality monitoring section contains below data",
  async ({ ctx }, data: DataTable) => {
    const personalDetailsPage = new PersonalDetailsPage(ctx.base.page);
    await personalDetailsPage.assertSections(data);
  },
