...
Then(
  "the sentence page is populated with title {string}",
...
Then(
  "the sentence page has the heading {string}",
  async ({ ctx }, heading: string) => {
    const sentencePage = new SentencePage(ctx.base.page);
...
Then(
  "the link {string} at sentence page works correctly",
