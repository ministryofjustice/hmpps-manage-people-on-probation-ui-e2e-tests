Feature: Log appointment outcome
  ...
  Scenario Outline: Validate appointment outcome journeys - <appointmentType> for <case_crn> - <outcomeType>
    ...
    Examples:
      ...
      | Y013602  |                                   | Planned video contact (NS)               | Wrexham Team Office | Attended - failed to comply | failure to comply    | Initiate a recall | Initiate a recall |
      | Y013525  | SA2020 Community Order (6 Months) | Planned contact - other than office (NS) | Wrexham Team Office | Unacceptable absence        | unacceptable absence | Initiate a recall | Initiate a recall |
