Feature: Create Appointments
    ...
    Scenario: Create appointment with criteria: inFuture, noText, defaultAttendee and sensitive, for case with criteria: singleSentence, noVisor
    ...
    @full @appointments @basic
    Scenario: Create appointment with criteria: inFuture, noText, defaultAttendee and non-sensitive, for case with criteria: singleSentence, noVisor
        When I complete the type attendance page with type "Planned office visit (NS)" and default attendee
    ...
    Scenario: Create appointment with criteria: inFuture, noText, defaultAttendee and locationNotNeeded for case with criteria: singleSentence, noVisor
    ...
    # Scenario: Create appointment with criteria: inPast and defaultAttendee for case with criteria: singleSentence, noVisor
