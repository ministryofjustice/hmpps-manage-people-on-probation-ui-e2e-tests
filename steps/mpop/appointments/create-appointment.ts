...
export const createAppointmentMPop = async (page: Page, crn: string, sentenceId: number, typeId: number, dateTime: mpopDateTime, locationId: number, note: string, sensitivity: boolean) => {
  ...
  await completeTypeAttendancePage(page, typeId)
